...
def get_champion_service(db, champion):
    champion=champions_repository.get_champion_by_id_repo(db, champion)
    if not champion:
...
def create_champion_service(db, champion):
    champion_existent=champions_repository.get_champion_by_id_repo(db, champion)
    if not champion_existent:
        return champions_repository.create_champion_repo(db, champion)
